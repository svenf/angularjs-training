describe('Product Service', function () {
    ...
    beforeEach(inject(function(_$httpBackend_) {
        ...
        $httpBackend.when('GET', 'http://services.odata.org/V3/Northwind/Northwind.svc/Products(1)?$format=json').respond(200, mockProduct);
    }));
    ...
    it('should update the product', inject(function (Products) {
        ...
        $httpBackend.expect('GET', 'http://services.odata.org/V3/Northwind/Northwind.svc/Products(1)?$format=json');
        $httpBackend.expect('PUT', 'http://services.odata.org/V3/Northwind/Northwind.svc/Products(1)?$format=json', updated).respond(200, updated);
